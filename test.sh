...
function test_fib_invalid_version
{
    check_call "/v2/fib/0" 501 "[]"
}

function test_fib_not_a_number
{
    check_call "/v1/fib/xxx" 400 "[]"
}

function test_fib_float_number
{
    check_call "/v1/fib/1.0" 400 "[]"
}

function test_fib_negative_numer
{
    check_call "/v1/fib/-1" 400 "[]"
}

function test_fib_overflowed_number
{
    check_call "/v1/fib/99999999999999" 413 "[]"
}
